...
namespace CD6{
    public partial class sos : System.Web.UI.Page{
        protected void Page_Load(object sender, EventArgs e){
            ...
            fake_sos.Columns.Add("DateCreated", typeof(DateTime));
            fake_sos.Columns.Add("DateModified", typeof(DateTime));
            fake_sos.Columns.Add("DateDue", typeof(DateTime));
            fake_sos.Columns.Add("Status", typeof(string));
            fake_sos.Columns.Add("ImageFileName", typeof(string));
            fake_sos.Columns.Add("recordModified", typeof(DateTime));
            fake_sos.Columns.Add("recordCreated", typeof(DateTime));
