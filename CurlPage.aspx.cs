    ...
    public partial class CurlPage : System.Web.UI.Page {
        ...
        protected void Page_Load(object sender, EventArgs e) {
            ...
            if (key == "12345") {
               ...
               gridView.DataBind();
               myEmail.sendEmail(Global.Email_from, Global.Admin_Email, "Weekly Dashboard of Sign out Sheets", "Hello! This is your weekly dashboard of overdue Sign Out Sheets, and ones that are close to overdue." + render(gridView) + "Thank you, and have a good day!  Regards, the CLAAMS System");
            } else {
